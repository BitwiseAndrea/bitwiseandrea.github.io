...
(lib.background = function(mode, startPosition, loop) {
  ...
  this.timeline.addTween(Tween.get(this.instance).to({
      alpha: 0
  }, 23).to({
      _off: true
  }, 1).wait(76));
  this.instance_1 = new lib.Symbol2();
  this.timeline.addTween(Tween.get(this.instance_1).wait(24).to({
      alpha: 0
  }, 24).to({
      _off: true
  }, 1).wait(51));
  ...
  this.timeline.addTween(Tween.get(this.instance_2).wait(24).to({
      _off: false
  }, 0).wait(25).to({
      alpha: 0
  }, 24).to({
  ...
  this.timeline.addTween(Tween.get(this.instance_3).wait(49).to({
      _off: false
  }, 0).wait(25).to({
      alpha: 0
  }, 25).wait(1));
  ...
  this.timeline.addTween(Tween.get(this.instance_4).wait(74).to({
      _off: false
  }, 0).wait(26));
}
